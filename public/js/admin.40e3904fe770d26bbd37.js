...
(function ($) {
    function initCharts() {
        $("canvas[data-target='chartjs']").each(function () {
            var title = $(this).attr('chartjs-title') ? $(this).attr('chartjs-title') : '';
            var type = $(this).attr('chartjs-type') ? $(this).attr('chartjs-type') : 'bar';
            var labels = JSON.parse($(this).attr('chartjs-labels'));
            var data = JSON.parse($(this).attr('chartjs-data'));
            var options = JSON.parse($(this).attr('chartjs-options') ? $(this).attr('chartjs-options') : '{}');
            var defaultOptions = {
                scales: {
                    yAxes: [{
                        ticks: {
